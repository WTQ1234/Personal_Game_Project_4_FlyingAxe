...
public class Player : Entity
{
    ...
    public override void Damage(int damage = 1, bool knock_back = false, Entity trans_damage_from = null)
    {
    ...
    public void ExhaustWeapon(int index)
    {
        ...
        screen_ui_info.RegisterParam("content", weapon.weaponInfo.shoot ? "子弹耗尽" : "耐久耗尽");
