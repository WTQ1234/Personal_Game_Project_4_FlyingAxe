...
namespace HRL
{
    public class MobAbilityBase : MonoBehaviour
    {
        ...
        public Entity Owner
        {
            get
            {
                if ((_owner == null) && (AbilityController != null))
                {
                    _owner = AbilityController.Owner;
                }
                if (_owner == null)
                {
        ...
        public string GetName() { _SetName(); return Name;}
